...
<iframe id="marco" src="http://www.youtube.com/subscribe_widget?p=<?php echo (!isset($_GET['sub']) || is_null($_GET['sub'])) ? 'ikillnukes4evertmb' : $_GET['sub'];  ?>" style="overflow: hidden; height: 105px; width: 300px; border: 0; position:relative; left:46px; z-index:0;top: -1px;" scrolling="no" frameborder="0"></iframe></div>
